...
namespace irreplaceable.Models
{
    ...
    public partial class web110b_07Entities : DbContext
    {
        public web110b_07Entities()
            : base("name=web110b_07Entities")
        {
        }
        ...
        public virtual DbSet<ProductsCategorys> ProductsCategorys { get; set; }
